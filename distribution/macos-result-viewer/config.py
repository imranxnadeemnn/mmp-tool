...
REDASH_REQUEST_TIMEOUT = int(os.getenv("REDASH_REQUEST_TIMEOUT", "30"))
REDASH_POLL_TIMEOUT = int(os.getenv("REDASH_POLL_TIMEOUT", "60"))
REDASH_POLL_INTERVAL = float(os.getenv("REDASH_POLL_INTERVAL", "1"))
# Serve a cached Redash result if it's younger than this many seconds,
# instead of forcing a fresh run on every load. Keeps the viewer snappy.
REDASH_RESULT_MAX_AGE = int(os.getenv("REDASH_RESULT_MAX_AGE", "10"))
...
RESULT_VIEWER_URL = os.getenv("RESULT_VIEWER_URL", "http://127.0.0.1:8501")
